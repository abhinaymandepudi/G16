...
public class IteratorExample implements Iterable<Item> {
	 ...
	 * of the array "arr", depending on the value of boolean "evens". Odd indexed
	 * elements are iterated in descending order. Normally we would use "Item"
	 * instead of "T" in the following class
	 */
 ...
 * Sample output:
 * 
 * Iterator illustration: Iterating with evens = true 0 2 4 6 8
 * 
 * Iterating with evens = false 9 7 5 3 1
 */
