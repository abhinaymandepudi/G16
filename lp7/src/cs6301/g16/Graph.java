 ...
 *
 * @author rbk Ver 1.1: 2017/08/28.  Updated some methods to public.  Added getName() to Vertex Ver
 * 1.2: 2017/09/08.  Added getVertex() method for GraphAlgorithm.java Ver 1.3: 2017/09/28.  Added
 * isDirected() and additional Vertex constructor Ver 2.0: 2017/10/11.  Added following OO features
 * to allow the use of cs6301.g00.Graph directly from cs6301.gXX, without having to copy the file:
 * Renamed v to vertex (better name), but v is left as a synonym for vertex for backward
 * compatibility.  Added a new field m for number of edges. Added name field to Edge to uniquely
 * identify edges. Added hashCode, equals to Vertex and Edge for using them as keys in hashmaps.
 * Changed == to equals() for Vertex and Edge checks for equality. Added methods fromVertex,
 * toVertex, getWeight, setWeight, getName, setName, and field "name" to Edge class. Changed addEdge
 * from void to return the Edge that it created. Added reverseIterator to Vertex and adj and revAdj
 * fields changed to public. Constructors of Vertex and Edge changed to public. Added methods
 * edgeSize, clear, setDirected, reverseGraph to Graph.
 */
...
public class Graph implements Iterable<Graph.Vertex> {
    ...
    public static class Edge {
        ...
        /**
         * Method to find the other end end of an edge, given a vertex reference This method is used
    ...
    /**
     * Method to add an edge to the graph This version is obsolete and kept for backward
     * compatibility
     *
