/**
 * @author rbk Singly linked list: for instructional purposes only Ver 1.0: 2017/08/08 Ver 1.1:
 * 2017/08/30: Fixed error: If last element of list is removed, "tail" is no longer a valid value.
